...
#define CORE_SPI1_MOSI_PORT GPIOA // PB5 Is another viable MOSI pin -Josh
...
#define CORE_USART1_TX_PORT GPIOA
#define CORE_USART1_TX_PIN  GPIO_PIN_9
#define CORE_USART1_TX_AF   7
#define CORE_USART1_RX_PORT GPIOA
#define CORE_USART1_RX_PIN  GPIO_PIN_10
